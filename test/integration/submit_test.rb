...
#   end
  ...
  test "should be able to submit through A+" do
    ...
    assert_equal [@student1.id, @student3.id], Submission.last.group.group_members.map{|m| m.user_id},  "Group should have right members"
    ...
    assert_equal [@student1.id, @student2.id], Submission.last.group.group_members.map{|m| m.user_id},  "Group should have right members"
    assert_equal @exercise, Submission.last.exercise,                                                   "Submission should be in right exercise"
    assert_equal [@student1.id, @student2.id], Group.last.group_members.map{|m| m.user_id},             "Group should have right members"
  end
